...
public class VentanaPagarEstudios extends JFrame {
	...
	public VentanaPagarEstudios() {
		...
		JLabel lblTitulo = new JLabel("AYUDA EN LA EDUCACIÓN DE LOS NIÑOS");
		...
		JComboBox CBAinyo = new JComboBox();
		CBAinyo.addItem(1);
		CBAinyo.addItem(2);
		CBAinyo.addItem(3);
		CBAinyo.addItem(4);
		...
		JLabel CBTitulo = new JLabel("AÑOS A PAGAR");
		panel_4.add(CBTitulo);
